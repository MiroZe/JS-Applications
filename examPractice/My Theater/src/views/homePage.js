...
const homeTemplate = (allList) => html`<section class="welcomePage">
...
<div id="events">
    ...
    <div class="theaters-container">
        ...
        ${allList.length > 0 ? allList.map(itemTemplate): html`<h4 class="no-event">No Events Yet...</h4>`}
...
export async function showHomePage(ctx) {
    ...
    ctx.render(homeTemplate(allList))
